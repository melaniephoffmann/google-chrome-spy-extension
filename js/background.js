...
console.log('probability_likelihood_female', probability_likelihood_female)
  ...
  (probability_likelihood_female =
    ...
    console.log('female_records_for_url, url', female_records_for_url, url)
    console.log('probability_likelihood_male, url', probability_likelihood_male, url)

}

function computeProbabilityOfLikelihoodMarital(url) {
  var elemForMarital = getElemForMarital(url);
  console.log('index for marital status', elemForMarital);
  ...
  console.log('probability_likelihood_single', probability_likelihood_single);
...
function computeProbabilityOfLikelihoodIncome(url) {
  ...
  probability_likelihood_high == null
    ...
    console.log('low_records_for_url, url', low_records_for_url, url)
    console.log('probability_likelihood_low, url', probability_likelihood_low, url)
}
...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
  ...
  console.log('testCheckUrlGenderDS', testCheckUrlGenderDS, testCheckUrlMaritalDS, testCheckUrlIncomeDS)
...
chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
  ...
  console.log('probability_likelihood_female', probability_likelihood_female)
    ...
    final_result_male = final_probability_male / final_result_female_male_below 
      ...
      console.log('final_probability_single,final_probability_relationship', final_probability_single, final_probability_relationship,final_probability_divorcedWidowed, final_probability_married)
